...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        Order buyRequest = new Order("BR1", "abc", OrderType.BUY, stock.getName(), 2, 300.0, LocalDateTime.now(), LocalDateTime.of(2025, 1, 1, 1, 1));
        Thread.sleep(10);
        ...
        System.out.println("Current State for " + stock.getName());
        ...
        System.out.println("Current State for " + stock1.getName());
